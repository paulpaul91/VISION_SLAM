...
public:
    ...
    //change 2017 7/13
    static long int jishu;
    static vector<float> pose_position_x;
    static vector<float> pose_position_y;
    static vector<float> pose_position_z;
    static vector<float> pose_pose_x;
    static vector<float> pose_pose_y;
    static vector<float> pose_pose_z;

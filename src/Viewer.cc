...
void Viewer::Run()
{
    ...
    //pangolin::Var<bool> menuSaveImage("menu.Save Image",false,false);//change
    //pangolin::Var<bool> menuLoadImage("menu.Load Image",false,false);//change
    //mpSystem->DeactivateLocalizationMode();//change
    ...
    //cv::namedWindow("Save Frame"); //change
    ...
    while(1)
    {
        ...
        //__________________________________________change save and load image
        // if(menuSaveImage)
        // {
        //     mpSystem->SaveImage();
        //     menuSaveImage = false;
        ...
        //cv::imshow("Save Frame",im); //change
        cv::waitKey(mT);
